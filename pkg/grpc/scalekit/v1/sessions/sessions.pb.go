...
const file_scalekit_v1_sessions_sessions_proto_rawDesc = "" +
	...
	"\n" +
	"total_size\x18\x04 \x01(\rB\xae\x01\x92A\xaa\x012\xa3\x01Total number of sessions matching the applied filter criteria, regardless of pagination. This represents the complete result set size before pagination is applied.J\x0242R\ttotalSize\"\xc5\x1c\n" +
	...
	"\x0elast_active_at\x18\r \x01(\v2\x1a.google.protobuf.TimestampB\xdc\x01\x92A\xd8\x012\xbd\x01Timestamp of the most recent user activity detected in this session. Updated on each API request or user interaction. Used to determine if a session has exceeded the idle timeout threshold.J\x16\"2025-01-15T10:55:30Z\"R\flastActiveAt\x12\xc0\x01\n" +
	"\x15authenticated_clients\x18\x0e \x03(\v2*.scalekit.v1.sessions.AuthenticatedClientsB_\x92A\\2ZDetails of the authenticated clients for this session: client ID and organization context.R\x14authenticatedClients\"\xed\r\n" +
	...
	"\tlongitude\x18\x05 \x01(\tB\xa6\x01\x92A\xa2\x012\x92\x01Longitude coordinate of the estimated location. Decimal format (e.g., '-122.4194'). Note: Represents IP geolocation center and may not be precise.J\v\"-122.4194\"R\tlongitude\"\x98\x02\n" +
	"\x14AuthenticatedClients\x12n\n" +
	"\tclient_id\x18\x01 \x01(\tBQ\x92AN2:Unique identifier of the authenticated client application.J\x10\"skc_1234567890\"R\bclientId\x12\x8f\x01\n" +
	"\x0forganization_id\x18\x02 \x01(\tBf\x92Ac2OActive or last active Organization ID associated with the authenticated client.J\x10\"org_1234567890\"R\x0eorganizationId2\xc8\x1f\n" +
	...
	"&\x1a$.scalekit.v1.sessions.SessionDetails\x82\xb5\x18\x02\x18D\x82\xd3\xe4\x93\x02\x1f\x12\x1d/api/v1/sessions/{session_id}\x12\xa2\x06\n" +
	...
	"-\x1a+.scalekit.v1.sessions.RevokeSessionResponse\x82\xb5\x18\x02\x18D\x82\xd3\xe4\x93\x02&\"$/api/v1/sessions/{session_id}/revoke\x12\xb0\a\n" +
	...
	"*\x1a(.scalekit.v1.sessions.UserSessionDetails\x82\xb5\x18\x02\x18D\x82\xd3\xe4\x93\x02\"\x12 /api/v1/users/{user_id}/sessions\x12\xbe\a\n" +
	...
	"5\x1a3.scalekit.v1.sessions.RevokeAllUserSessionsResponse\x82\xb5\x18\x02\x18D\x82\xd3\xe4\x93\x02)\"'/api/v1/users/{user_id}/sessions/revoke\x1a\xbe\x03\x92A\xba\x03\n" +
