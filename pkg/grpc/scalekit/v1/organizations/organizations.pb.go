...
const file_scalekit_v1_organizations_organizations_proto_rawDesc = "" +
	...
	"\x03sso\x10\x02\x1a\x02\x10\x012\x9cL\n" +
	...
	"\rOrganizations\x12D{{import \"proto/scalekit/v1/organizations/organization_details.md\"}}B\xec(\x92A\xe0&\x12\x86\"\n" +
	"\rScalekit APIs\x12\xf7 # Introduction\n" +
	"\n" +
