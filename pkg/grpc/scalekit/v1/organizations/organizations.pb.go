...
const file_scalekit_v1_organizations_organizations_proto_rawDesc = "" +
	...
	"\forganization\x18\x01 \x01(\v2'.scalekit.v1.organizations.OrganizationBM\x92AJ2HThe newly created organization containing its ID, settings, and metadataR\forganization\"\x9d\x05\n" +
	"\x12CreateOrganization\x12\x81\x01\n" +
	"\fdisplay_name\x18\x04 \x01(\tB^\x92AQ2?Name of the organization. Must be between 1 and 200 characters.J\x0e\"Megasoft Inc\"\xbaH\ar\x05\x10\x01\x18\xc8\x01R\vdisplayName\x12\xa0\x01\n" +
	...
	"(UpdateOrganizationSessionSettingsRequest\x12\x1e\n" +
	"\x02id\x18\x01 \x01(\tB\x0e\xbaH\vr\t\x10\x01\x18 :\x03orgR\x02id\x125\n" +
	"\x0eenvironment_id\x18\x02 \x01(\tB\x0e\xbaH\vr\t\x10\x01\x18 :\x03envR\renvironmentId\x12i\n" +
	"\x10session_settings\x18\x03 \x01(\v26.scalekit.v1.organizations.OrganizationSessionSettingsB\x06\xbaH\x03\xc8\x01\x01R\x0fsessionSettings\"\xde\x01\n" +
	")UpdateOrganizationSessionSettingsResponse\x12%\n" +
	"\x0eenvironment_id\x18\x01 \x01(\tR\renvironmentId\x12'\n" +
	"\x0forganization_id\x18\x02 \x01(\tR\x0eorganizationId\x12a\n" +
	"\x10session_settings\x18\x03 \x01(\v26.scalekit.v1.organizations.OrganizationSessionSettingsR\x0fsessionSettings\"\xeb\x02\n" +
	"\x1bOrganizationSessionSettings\x12U\n" +
	"\x18absolute_session_timeout\x18\x01 \x01(\v2\x1b.google.protobuf.Int32ValueR\x16absoluteSessionTimeout\x12X\n" +
	"\x1asession_management_enabled\x18\x02 \x01(\v2\x1a.google.protobuf.BoolValueR\x18sessionManagementEnabled\x12M\n" +
	"\x14idle_session_timeout\x18\x03 \x01(\v2\x1b.google.protobuf.Int32ValueR\x12idleSessionTimeout\x12L\n" +
	"\x14idle_session_enabled\x18\x04 \x01(\v2\x1a.google.protobuf.BoolValueR\x12idleSessionEnabled\"~\n" +
	"%GetOrganizationSessionSettingsRequest\x12\x1e\n" +
	"\x02id\x18\x01 \x01(\tB\x0e\xbaH\vr\t\x10\x01\x18 :\x03orgR\x02id\x125\n" +
	"\x0eenvironment_id\x18\x02 \x01(\tB\x0e\xbaH\vr\t\x10\x01\x18 :\x03envR\renvironmentId\"\x81\x01\n" +
	"(CreateOrganizationSessionSettingsRequest\x12\x1e\n" +
	"\x02id\x18\x01 \x01(\tB\x0e\xbaH\vr\t\x10\x01\x18 :\x03orgR\x02id\x125\n" +
	"\x0eenvironment_id\x18\x02 \x01(\tB\x0e\xbaH\vr\t\x10\x01\x18 :\x03envR\renvironmentId\"\xde\x01\n" +
	")CreateOrganizationSessionSettingsResponse\x12%\n" +
	"\x0eenvironment_id\x18\x01 \x01(\tR\renvironmentId\x12'\n" +
	"\x0forganization_id\x18\x02 \x01(\tR\x0eorganizationId\x12a\n" +
	"\x10session_settings\x18\x03 \x01(\v26.scalekit.v1.organizations.OrganizationSessionSettingsR\x0fsessionSettings\"\xdb\x01\n" +
	"&GetOrganizationSessionSettingsResponse\x12%\n" +
	"\x0eenvironment_id\x18\x01 \x01(\tR\renvironmentId\x12'\n" +
	"\x0forganization_id\x18\x02 \x01(\tR\x0eorganizationId\x12a\n" +
	"\x10session_settings\x18\x03 \x01(\v26.scalekit.v1.organizations.OrganizationSessionSettingsR\x0fsessionSettings\"\x81\x01\n" +
	"(DeleteOrganizationSessionSettingsRequest\x12\x1e\n" +
	"\x02id\x18\x01 \x01(\tB\x0e\xbaH\vr\t\x10\x01\x18 :\x03orgR\x02id\x125\n" +
	"\x0eenvironment_id\x18\x02 \x01(\tB\x0e\xbaH\vr\t\x10\x01\x18 :\x03envR\renvironmentId\"\x8e\x04\n" +
	...
	"p*\x1bOrganization Feature Toggle2@Controls the activation state of a specific organization feature\xd2\x01\x04name\xd2\x01\aenabled*1\n" +
	"\aFeature\x12\x0f\n" +
	"\vUNSPECIFIED\x10\x00\x12\f\n" +
	"\bdir_sync\x10\x01\x12\a\n" +
	"\x03sso\x10\x022\xf54\n" +
	...
	"4\x1a2.scalekit.v1.organizations.GetOrganizationResponse\x82\xb5\x18\x02\x184\x82\xd3\xe4\x93\x02\x1c\x12\x1a/api/v1/organizations/{id}\x12\xc4\x04\n" +
	"\x10ListOrganization\x123.scalekit.v1.organizations.ListOrganizationsRequest\x1a4.scalekit.v1.organizations.ListOrganizationsResponse\"\xc4\x03\x92A\x9d\x03\n" +
	...
	"\x03400\x12\x14\n" +
	"\x12Invalid page token\x82\xb5\x18\x02\x18T\x82\xd3\xe4\x93\x02\x17\x12\x15/api/v1/organizations\x12\xe2\x04\n" +
	"\x12SearchOrganization\x125.scalekit.v1.organizations.SearchOrganizationsRequest\x1a6.scalekit.v1.organizations.SearchOrganizationsResponse\"\xdc\x03\x92A\xae\x03\n" +
	...
	"8\x1a6.scalekit.v1.organizations.SearchOrganizationsResponse\x82\xb5\x18\x02\x18T\x82\xd3\xe4\x93\x02\x1e\x12\x1c/api/v1/organizations:search\x12\xcf\x02\n" +
	...
	"\x03404\x12F\n" +
	"DOrganization not found - the specified organization ID doesn't exist\x82\xb5\x18\x02\x18T\x82\xd3\xe4\x93\x02/:\bsettings2#/api/v1/organizations/{id}/settings\x12\xf8\x01\n" +
	"!CreateOrganizationSessionSettings\x12C.scalekit.v1.organizations.CreateOrganizationSessionSettingsRequest\x1aD.scalekit.v1.organizations.CreateOrganizationSessionSettingsResponse\"H\x82\xb5\x18\x02\x18T\xfa\xd2\xe4\x93\x02\t\x12\aPREVIEW\x82\xd3\xe4\x93\x02-\"+/api/v1/organizations/{id}/session-settings\x12\x8c\x03\n" +
	"\x1eGetOrganizationSessionSettings\x12@.scalekit.v1.organizations.GetOrganizationSessionSettingsRequest\x1aA.scalekit.v1.organizations.GetOrganizationSessionSettingsResponse\"\xe4\x01\x92A\x98\x01\n" +
	"\rOrganizations\x12!Get Organization Session SettingsJd\n" +
	"\x03200\x12]\n" +
	"\x14Updated Successfully\x12E\n" +
	"C\x1aA.scalekit.v1.organizations.GetOrganizationSessionSettingsResponse\x82\xb5\x18\x02\x18T\xfa\xd2\xe4\x93\x02\t\x12\aPREVIEW\x82\xd3\xe4\x93\x02-\x12+/api/v1/organizations/{id}/session-settings\x12\x8a\x02\n" +
	"!UpdateOrganizationSessionSettings\x12C.scalekit.v1.organizations.UpdateOrganizationSessionSettingsRequest\x1aD.scalekit.v1.organizations.UpdateOrganizationSessionSettingsResponse\"Z\x82\xb5\x18\x02\x18T\xfa\xd2\xe4\x93\x02\t\x12\aPREVIEW\x82\xd3\xe4\x93\x02?:\x10session_settings2+/api/v1/organizations/{id}/session-settings\x12\xca\x01\n" +
	"!DeleteOrganizationSessionSettings\x12C.scalekit.v1.organizations.DeleteOrganizationSessionSettingsRequest\x1a\x16.google.protobuf.Empty\"H\x82\xb5\x18\x02\x18T\xfa\xd2\xe4\x93\x02\t\x12\aPREVIEW\x82\xd3\xe4\x93\x02-*+/api/v1/organizations/{id}/session-settings\x1aX\x92AU\n" +
	"\rOrganizations\x12D{{import \"proto/scalekit/v1/organizations/organization_details.md\"}}B\xcc!\x92A\xc3\x1f\x12\xb1\x15\n" +
	"\rScalekit APIs\x12\xa2\x14# Introduction\n" +
	"\n" +
	...
	"\n" +
	"Apache 2.0\x12*http://www.apache.org/licenses/LICENSE-2.02\x051.0.0\x1a\b$ENV_URL*\x01\x022\x10application/json:\x10application/jsonZ\xa2\x01\n" +
	"\x0f\n" +
	"\tBasicAuth\x12\x02\b\x01\n" +
	"\x8e\x01\n" +
	"\x06OAuth2\x12\x83\x01\b\x03(\x042\x1fhttp://$ENV_URL/oauth/authorize:\x1bhttp://$ENV_URL/oauth/tokenB?\n" +
	"=\n" +
	"\x0eoffline_access\x12+Grants a refresh token with absolute expiryj\x0f\n" +
	"\rOrganizationsj\xfe\x01\n" +
	"\x05Users\x12\xf4\x01User management endpoints for individual accounts within the organization. These endpoints allow for creating, reading, updating, and deleting user accounts, as well as managing user roles and permissions for accessing organizational resources.j\xc3\x02\n" +
	"\tDirectory\x12\xb5\x02The Directory API lets you connect external identity providers to your organizations. Use these endpoints to view users and groups, enable or disable directory connections, and configure access settings. Supports identity systems like Okta, Microsoft Entra ID, and Google Workspace through standard protocols.jO\n" +
	"\vConnections\x12@{{import \"proto/scalekit/v1/connections/connection_details.md\"}}j\xf6\x01\n" +
	"\x0eClient Configs\x12\xe3\x01Endpoints for managing client application configurations. Registered client applications can use these endpoints to retrieve and modify their configuration settings, including redirect URIs and other client-specific parameters.jh\n" +
	"\x05Roles\x12_Endpoints for managing roles and permissions for users and organizations. More APIs coming soonr+\n" +
