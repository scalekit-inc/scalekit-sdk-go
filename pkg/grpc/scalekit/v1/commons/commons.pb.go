...
const file_scalekit_v1_commons_commons_proto_rawDesc = "" +
	"\n" +
	"!scalekit/v1/commons/commons.proto\x12\x13scalekit.v1.commons\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\"\x88\x0e\n" +
	...
	"\n" +
	"expires_at\x18\r \x01(\v2\x1a.google.protobuf.TimestampB+\x92A(2&Timestamp when the invitation expired.H\x05R\texpiresAt\x88\x01\x01\x12W\n" +
	"\x13provisioning_method\x18\x0e \x01(\tB!\x92A\x1e2\x1cHow the user was provisionedH\x06R\x12provisioningMethod\x88\x01\x01\x1a;\n" +
