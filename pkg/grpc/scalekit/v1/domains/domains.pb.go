...
const file_scalekit_v1_domains_domains_proto_rawDesc = "" +
	...
	"\adomains\x18\x01 \x03(\tBu\x92Ar2LArray of domain names that are authorized for use with the specified origin.J\"[\"example.com\", \"app.example.com\"]R\adomains\"\xdd\x10\n" +
	"\x06Domain\x12j\n" +
	...
	"\x0forganization_id\x18\x04 \x01(\tBK\x92AH2-The organization to which the domain belongs.J\x17\"org_81667076086825451\"R\x0eorganizationId\x12\xa3\x01\n" +
	"\rconnection_id\x18\x05 \x01(\tB~\x92Al2XOptional identity provider connection ID associated with this domain for enterprise SSO.J\x10\"conn_123456789\"\xfa\xd2\xe4\x93\x02\t\x12\aPREVIEWR\fconnectionId\x12\xa8\x01\n" +
	...
	"updateTime\x12{\n" +
	"\n" +
	"created_by\x18\v \x01(\tBW\x92AE2?Optional identifier of the user who created this domain record.J\x02\"\"\xfa\xd2\xe4\x93\x02\t\x12\aPREVIEWH\x00R\tcreatedBy\x88\x01\x01\x12\xba\x02\n" +
