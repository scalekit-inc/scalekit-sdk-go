...
const file_scalekit_v1_domains_domains_proto_rawDesc = "" +
	...
	"\x06domain\x18\x01 \x01(\v2\x1b.scalekit.v1.domains.DomainBe\x92Ab2`The newly created domain object with all configuration details and system-generated identifiers.R\x06domain\"\xe6\x04\n" +
	"\fCreateDomain\x12\xf6\x01\n" +
	"\x06domain\x18\x01 \x01(\tB\xdd\x01\x92A\xcc\x012\xb3\x01The domain name to be configured. Must be a valid business domain you control. Public and disposable domains (gmail.com, outlook.com, etc.) are automatically blocked for security.J\x14\"customerdomain.com\"\xbaH\n" +
	"\xc8\x01\x01r\x05\x10\x04\x18\xff\x01R\x06domain\x12\xdc\x02\n" +
	"\vdomain_type\x18\x02 \x01(\x0e2\x1f.scalekit.v1.domains.DomainTypeB\x99\x02\x92A\x95\x022\xfb\x01The domain type.\n" +
	...
	"\x06domain\x18\x01 \x01(\v2\x1b.scalekit.v1.domains.DomainBk\x92Ah2fThe requested domain object with complete details including domain type, timestamps and configuration.R\x06domain\"\xeb\x05\n" +
	...
	"pageNumber\x12\xdc\x02\n" +
	"\vdomain_type\x18\a \x01(\x0e2\x1f.scalekit.v1.domains.DomainTypeB\x99\x02\x92A\x95\x022\xfb\x01The domain type.\n" +
	"- ALLOWED_EMAIL_DOMAIN: trusted domain used to suggest the organization in the organization switcher during sign-in/sign-up.\n" +
	"- ORGANIZATION_DOMAIN: SSO discovery domain used to route users to the correct SSO provider and enforce SSO.\n" +
	"J\x15\"ORGANIZATION_DOMAIN\"R\n" +
	"domainTypeB\f\n" +
	...
	"3\x1a1.scalekit.v1.domains.ListAuthorizedDomainResponse\x82\xb5\x18\x02\x18\x01\xfa\xd2\xe4\x93\x02\t\x12\aPREVIEW\x82\xd3\xe4\x93\x02\x1a\x12\x18/api/v1/domains/{origin}\x1a\xf8\x03\x92A\xf4\x03\n" +
	"\aDomains\x12\xe8\x03Manage organization-level domains. Scalekit supports two domain types:\n" +
	"\n" +
