...
func (x *Connection) GetGoogleDwdConfig() *GoogleDWDConfig {
	if x != nil {
		if x, ok := x.Settings.(*Connection_GoogleDwdConfig); ok {
...
func (x *UpdateConnection) GetGoogleDwdConfig() *GoogleDWDConfig {
	if x != nil {
		if x, ok := x.Settings.(*UpdateConnection_GoogleDwdConfig); ok {
			return x.GoogleDwdConfig
		}
	}
	return nil
...
const file_scalekit_v1_connections_connections_proto_rawDesc = "" +
	...
	"\x0fwebauthn_config\x18\x1b \x01(\v2-.scalekit.v1.connections.WebAuthConfigurationBW\x92AT2RConfiguration details for WebAuthn (passkeys). Present only when type is WEBAUTHN.H\x00R\x0ewebauthnConfig\x12\xbb\x01\n" +
	"\x11google_dwd_config\x18\x1c \x01(\v2(.scalekit.v1.connections.GoogleDWDConfigBc\x92A`2^Configuration details for Google Domain-Wide Delegation. Present only when type is GOOGLE_DWD.H\x00R\x0fgoogleDwdConfig\x12}\n" +
	...
	"\adomains\x18\x18 \x03(\v2\x1b.scalekit.v1.domains.DomainBs\x92Ap2SDomain associated with this connection, used for domain-based authentication flows.J\x19[{\"name\": \"example.com\"}]R\adomains\x1aC\n" +
	...
	"connectionJ\x04\b\x02\x10\x03\"\xfd\x12\n" +
	...
	"\x0fwebauthn_config\x18\x18 \x01(\v2-.scalekit.v1.connections.WebAuthConfigurationBW\x92AT2RConfiguration details for WebAuthn (passkeys). Present only when type is WEBAUTHN.H\x00R\x0ewebauthnConfig\x12\xaf\x01\n" +
	"\x11google_dwd_config\x18\x19 \x01(\v2(.scalekit.v1.connections.GoogleDWDConfigBW\x92AT2RGoogle Domain-Wide Delegation configuration. Present only when type is GOOGLE_DWD.H\x00R\x0fgoogleDwdConfig\x12&\n" +
	...
	"\x14service_account_json\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueBW\x92AQ2OGoogle Cloud service account JSON key. Write-only: reads return a masked value.\xe0A\x04R\x12serviceAccountJson\x129\n" +
	"\x06scopes\x18\x02 \x03(\tB!\x92A\x1e2\x1cOAuth 2.0 scopes to request.R\x06scopes\x12\x87\x01\n" +
	"\ttoken_uri\x18\x03 \x01(\v2\x1c.google.protobuf.StringValueBL\x92AI2GGoogle token endpoint. Defaults to https://oauth2.googleapis.com/token.R\btokenUri\"\xf4\a\n" +
	...
	"\tlogin_uvd\x18\x04 \x01(\v2\x19.google.protobuf.DurationBX\x92AF2<Login timeout duration when user verification is discouraged:\x06\"300s\"\xbaH\f\xaa\x01\t\"\x03\b\x88\x0e2\x02\bxR\bloginUvd\"\xf7\x15\n" +
	...
	"\n" +
	"sp_slo_url\x18\x16 \x01(\v2\x1c.google.protobuf.StringValueBR\x92AO2\x18Service Provider SLO URLJ3\"https://env.scalekit.com/sso/v1/saml/conn_123/slo\"R\bspSloUrl\x12\xc6\x01\n" +
	"\x1async_user_profile_on_login\x18\x17 \x01(\v2\x1a.google.protobuf.BoolValueBn\x92Ak2cIndicates whether user profiles should be synchronized with the identity provider upon each log-in.J\x04trueR\x16syncUserProfileOnLogin\x12\xba\x01\n" +
	"!jit_provisioning_with_sso_enabled\x18\x18 \x01(\v2\x1a.google.protobuf.BoolValueBT\x92AQ2IIndicates if Just In Time user provisioning is enabled for the connectionJ\x04trueR\x1djitProvisioningWithSsoEnabledJ\x04\b\v\x10\f\"\xff\x16\n" +
	...
	"\n" +
	"sp_slo_url\x18\x15 \x01(\v2\x1c.google.protobuf.StringValueBZ\x92AT2\x18Service Provider SLO urlJ8\"https://yourapp.com/sso/v1/saml/conn_1234/slo/callback\"\xe0A\x03R\bspSloUrl\x12\xc6\x01\n" +
	"\x1async_user_profile_on_login\x18\x16 \x01(\v2\x1a.google.protobuf.BoolValueBn\x92Ak2cIndicates whether user profiles should be synchronized with the identity provider upon each log-in.J\x04trueR\x16syncUserProfileOnLogin\x12\xba\x01\n" +
	"!jit_provisioning_with_sso_enabled\x18\x17 \x01(\v2\x1a.google.protobuf.BoolValueBT\x92AQ2IIndicates if Just In Time user provisioning is enabled for the connectionJ\x04trueR\x1djitProvisioningWithSsoEnabled\"\xbf\x03\n" +
	...
	">\x1a<.scalekit.v1.connections.ListOrganizationConnectionsResponse\x82\xb5\x18\x02\x18D\xfa\xd2\xe4\x93\x02\t\x12\aPREVIEW\x82\xd3\xe4\x93\x02%\x12#/api/v1/organizations/-/connections\x12\xcd\x03\n" +
	...
	"@\x1a>.scalekit.v1.connections.SearchOrganizationConnectionsResponse\x82\xb5\x18\x02\x18D\xfa\xd2\xe4\x93\x02\t\x12\aPREVIEW\x82\xd3\xe4\x93\x02,\x12*/api/v1/organizations/-/connections:search\x12\xf1\x02\n" +
...
func file_scalekit_v1_connections_connections_proto_init() {
	...
	file_scalekit_v1_connections_connections_proto_msgTypes[4].OneofWrappers = []any{}
	file_scalekit_v1_connections_connections_proto_msgTypes[5].OneofWrappers = []any{}
	...
	file_scalekit_v1_connections_connections_proto_msgTypes[12].OneofWrappers = []any{
	...
	file_scalekit_v1_connections_connections_proto_msgTypes[33].OneofWrappers = []any{}
	file_scalekit_v1_connections_connections_proto_msgTypes[49].OneofWrappers = []any{}
	file_scalekit_v1_connections_connections_proto_msgTypes[52].OneofWrappers = []any{}
	type x struct{}
